...
var rootCmd = &cobra.Command{
	...
	Long:  `Tool for performing Liferay Client Extension related operations.`,
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.lcectl.yaml)")
